...
@section('body')
    ...
    @if(Auth::user()->admin_level == 1)
        <div class="table-responsive">
            ...
            <form action="{{route('adminUpdateOrder',['order_id' => $order->id ])}} " method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="delivery_date" id="delivery_date" placeholder="delivery date" value="{{$order->delivery_date}}" required>
                </div>
